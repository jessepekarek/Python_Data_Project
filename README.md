...
- Python is a versitile skill, highly demanded ascross all three roles, but most prominently for Data Scientists (72%) and Data Engineers (65%). 
...
- Both Python and Tableau show relatively stable demand throughout the year with some fluctuations but remain essential skills for data analysts.  Power BI, while less demanded compared to t others, shows a slight upward trend towards the year's end.
...
ticks_x = plt.FuncFormatter(lambda y, pos: 
f'${int(y/1000)}K')
...
#### Insights
- There's a significant variation in salary ranges across different job titles.  Senior Data Scientists tend to have the highest salary potential with up to $600K, indicating the high value placed on advanced data skills and experience in the industry.

- Senior Data Engineer and Senior Data Scientist roles show a considerable number of outliers on the higher end of the salary spectrum, suggesting that exceptional skills or circumstances can lead to high pay in those roles.  In contract, Data Analyst roles demonstrate more consistency in salary, with fewer outliers.
...
![The Highest Paid & Most In-Demand Skills forData Analysts in the US](3_Project/images/Highest_Paid_and_Most_In_Demand_Skills_for_Data_Analysts_in_the_US.png)
